...
(function() {
  var Bottleneck, DEFAULT_PRIORITY, Events, LocalDatastore, NUM_PRIORITIES, Queues, RedisDatastore, States, Sync, parser,
    splice = [].splice;
    ...
    class Bottleneck {
      ...
      submit(...args) {
        ...
        if (typeof args[0] === "function") {
          ref = args, [task, ...args] = ref, [cb] = splice.call(args, -1);
          options = parser.load({}, this.jobDefaults, {});
        } else {
          ref1 = args, [options, task, ...args] = ref1, [cb] = splice.call(args, -1);
